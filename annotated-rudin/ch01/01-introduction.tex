...
\smallskip
\textbf{8. Transport structure along $f$ or $f^{-1}$.} Added by Chapter 4,
whose theorems mostly carry Chapter 2's structures across a continuous map;
listed here so the index stays complete. Nothing in this chapter uses it.
\end{roadmap}
...
\end{tikzpicture}
\end{center}
\figcap{Two squares of side $n$ are dropped into opposite corners of a square of
side $m$.}
