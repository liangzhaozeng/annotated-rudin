...
order. \emph{1.20} tests whether you understood why a cut never has a largest
member.
...
$|\mathbf{x}-\mathbf{y}| = d > 0$, and $r > 0$. Prove:
  ...
  \end{tikzpicture}
  \end{center}
  \figcap{The three cases drawn in the plane, where the intersection is two points, one, or
